...
if ($result->num_rows > 0) {
    ...
    echo '<div class="page-header"><h3> Artists Data list(Part 1)</h3></div>';
    while($row = $result->fetch_assoc()) {
        
        echo "<a href='Part02_SingleArtist.php?id=".$row["ArtistID"]."'>" . utf8_encode($row["FirstName"])." ".utf8_encode($row["LastName"])."(".$row["YearOfBirth"]."-" .$row["YearOfDeath"].")</a><br />";
    }
} else {
